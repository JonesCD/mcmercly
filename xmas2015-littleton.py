...
peeps = ['mollie', 'eric', 'marilyn', 'rich', 'lessa', 'chris']
peeps_dict = {}
for i in peeps:
...
peeps_addy_dict = {'chris': 'jones.christopherd@gmail.com', 'lessa': '', 'mollie': '', 'eric': '', 'marilyn': '', 'rich': ''}

msg = "Hello, %s! We are having another, smaller McMercly. You've been assigned two people to get a gift for. They may or may not be the same person, but you can be assured that they won't be: your spouse. The possibility that Santa and Elf recipients may be the same person is a bug. In fact, with this small number of people, it's incredibly likely. Some of my tests had both lists as IDENTICAL. I can't fix it. I don't have the skill. Don't be a jerk about it. If you get the same person, that does not mean you can just combine the two gifts. Anyway, you're 'Santa' to someone. That means you shall not spend more than $125 in buying/crafting/baking/shipping them a gift (your time has no value here - accept that). We will have a wishlist, as per usual. You're also an 'Elf' to someone. That means you shall not spend more than $10 on that person. There is a BIG PRIZE for getting as close as possible to those limits, and a HUGE PENALTY for exceeding. Do your best. You are Santa to %s, and you are an Elf to %s. Wishlists to follow in separate email, and remember, Elf gifts cannot be off the lists. Gift cards are forbidden. Go, and be merry. Also, make sure they arrive by XMAS (shipping costs are part of the limits)!!!  PS. If the name at the beginning of this email is NOT YOU, let me know ASAP - I goofed. Also, if you are Santa or Elf to your spouse or yourself, please let me know that too. I'm no pro, you know?  PPS. I don't know how to do a carriage return in this thing."
