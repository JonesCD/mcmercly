...
ct = ids(9);
cr = ids(10);
id1 = fopen('name_codes2012.txt','r+');
...
%Papa gets Yummy
id2 = fopen('name_codes-giving2012.txt','w+');
%fprintf(id2,'%d \t     is giving to ',p);
%fprintf(id2,'Yummy');

%now for Yummy's pick (not Papa or Yummy)
mi = 1;
while (mi==1)|(mi==2)
...
mi = 1;
while (mi==3)|(mi==4)|(mi==1)|(mi==my)|(mi==mmo)|(mi==7)|(mi==2)
    temprand = randi([100000000,999999999],1,1);
    diff = abs(temprand - ids);
    [mindiff,minindex] = min(diff);
    mi = minindex;
...
mi = 1;
while (mi==5)|(mi==6)|(mi==my)|(mi==me)|(mi==mmo)|(mi==1)
    temprand = randi([100000000,999999999],1,1);
    diff = abs(temprand - ids);
    [mindiff,minindex] = min(diff);
    mi = minindex;
...
mi = 1;
while (mi==1)|(mi==5)|(mi==6)|(mi==my)|(mi==me)|(mi==mmo)|(mi==mr)
    temprand = randi([100000000,999999999],1,1);
    diff = abs(temprand - ids);
    [mindiff,minindex] = min(diff);
    mi = minindex;
...
mi = 1;
while (mi==1)|(mi==7)|(mi==8)|(mi==my)|(mi==me)|(mi==mmo)|(mi==mr)|(mi==mma)
    temprand = randi([100000000,999999999],1,1);
    diff = abs(temprand - ids);
    [mindiff,minindex] = min(diff);
    mi = minindex;
...
mi = 1;
while (mi==1)|(mi==7)|(mi==8)|(mi==my)|(mi==me)|(mi==mmo)|(mi==mr)|(mi==mma)|(mi==mcj)
    temprand = randi([100000000,999999999],1,1);
    diff = abs(temprand - ids);
    [mindiff,minindex] = min(diff);
    mi = minindex;
...
mi = 1;
while (mi==1)|(mi==9)|(mi==10)|(mi==my)|(mi==me)|(mi==mmo)|(mi==mr)|(mi==mma)|(mi==mcj)|(mi==ml)
    temprand = randi([100000000,999999999],1,1);
    diff = abs(temprand - ids);
    [mindiff,minindex] = min(diff);
    mi = minindex;
...
[mindiff,minindex] = min(diff);
mi = minindex;
if (mi==1)|(mi==9)|(mi==10)|(mi==my)|(mi==me)|(mi==mmo)|(mi==mr)|(mi==mma)|(mi==mcj)|(mi==ml)|(mi==mct)
...
id3 = fopen('name_codes-giving2-2012.txt','w+');
...
mi = 1;
while (mi==3)|(mi==4)|(mi==mmo)|(mi==1)|(mi==my2)
    temprand = randi([100000000,999999999],1,1);
    diff = abs(temprand - ids);
    [mindiff,minindex] = min(diff);
    mi = minindex;
...
mi = 1;
while (mi==3)|(mi==4)|(mi==me)|(mi==1)|(mi==my2)|(mi==mmo2)
    temprand = randi([100000000,999999999],1,1);
    diff = abs(temprand - ids);
    [mindiff,minindex] = min(diff);
    mi = minindex;
...
mi = 1;
while (mi==5)|(mi==6)|(mi==mr)|(mi==1)|(mi==my2)|(mi==mmo2)|(mi==me2)
    temprand = randi([100000000,999999999],1,1);
    diff = abs(temprand - ids);
    [mindiff,minindex] = min(diff);
    mi = minindex;
...
mi = 1;
while (mi==5)|(mi==6)|(mi==mma)|(mi==1)|(mi==my2)|(mi==mmo2)|(mi==me2)|(mi==mr2)
    temprand = randi([100000000,999999999],1,1);
    diff = abs(temprand - ids);
    [mindiff,minindex] = min(diff);
    mi = minindex;
...
mi = 1;
while (mi==7)|(mi==8)|(mi==mcj)|(mi==1)|(mi==my2)|(mi==mmo2)|(mi==me2)|(mi==mr2)|(mi==mma2)
    temprand = randi([100000000,999999999],1,1);
    diff = abs(temprand - ids);
    [mindiff,minindex] = min(diff);
    mi = minindex;
...
mi = 1;
while (mi==7)|(mi==8)|(mi==ml)|(mi==1)|(mi==my2)|(mi==mmo2)|(mi==me2)|(mi==mr2)|(mi==mma2)|(mi==mcj2)
    temprand = randi([100000000,999999999],1,1);
    diff = abs(temprand - ids);
    [mindiff,minindex] = min(diff);
    mi = minindex;
...
mi = 1;
while (mi==9)|(mi==10)|(mi==mct)|(mi==1)|(mi==my2)|(mi==mmo2)|(mi==me2)|(mi==mr2)|(mi==mma2)|(mi==mcj2)|(mi==ml2)
    temprand = randi([100000000,999999999],1,1);
    diff = abs(temprand - ids);
    [mindiff,minindex] = min(diff);
    mi = minindex;
...
[mindiff,minindex] = min(diff);
mi = minindex;
if (mi==9)|(mi==10)|(mi==mcath)|(mi==1)|(mi==my2)|(mi==mmo2)|(mi==me2)|(mi==mr2)|(mi==mma2)|(mi==mcj2)|(mi==ml2)|(mi==mct2)
